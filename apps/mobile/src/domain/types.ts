...
export interface Skill { id: EntityId; goalId: EntityId; title: string; description?: string; supportLevel: SupportLevel; status: SkillStatus; masteryScore: number; nextReviewAt?: string; createdAt: string; updatedAt: string; }
export interface SkillEdge { id: EntityId; parentSkillId: EntityId; childSkillId: EntityId; }
export interface Quest { id: EntityId; title: string; description?: string; supportLevel: SupportLevel; status: QuestStatus; xpReward: number; scheduledFor?: string; createdAt: string; updatedAt: string; }
